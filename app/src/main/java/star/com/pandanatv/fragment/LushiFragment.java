...
import star.com.pandanatv.adapter.LuShiAdapter;
 ...
 */
public class LushiFragment extends Fragment {
    protected View rootView;
    protected GridView mZhiboGrid;

    public static LushiFragment newInstance(int key) {

        Bundle args = new Bundle();
        args.putInt("key",key);
        LushiFragment fragment = new LushiFragment();
        ...
        if(key==3){
            ...
            httpUtils.send(HttpRequest.HttpMethod.GET, url, new RequestCallBack<String>() {
                ...
                public void onSuccess(ResponseInfo<String> responseInfo) {
                    ...
                    Gson gson=new Gson();
                    LuShiData luShiData = gson.fromJson(result, LuShiData.class);
                    List<LuShiData.DataBean.ItemsBean> items = luShiData.getData().getItems();
                    LuShiAdapter adapter = new LuShiAdapter();
                    adapter.setDataBeen((ArrayList<LuShiData.DataBean.ItemsBean>) items);
